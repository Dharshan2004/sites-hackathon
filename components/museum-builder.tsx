  ...
  return (
    <main className="museum-shell min-h-[100dvh]">
                    ...
                    {ARCHITECTURES.map((item) => (
                      ...
                      >
                        <input
                          ...
                          name="architecture"
                          value={item.id}
                          checked={architecture === item.id}
                          onChange={() => chooseArchitecture(item.id)}
                          className="sr-only"
      ...
      <section className="promise-strip" aria-label="What every museum includes">
        <div><strong>01</strong><span>OpenAI-generated room</span></div>
        <div><strong>08</strong><span>architectural worlds</span></div>
        <div><strong>03</strong><span>OpenAI vision-mapped exhibits</span></div>
